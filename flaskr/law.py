...
if __name__ == '__main__':
    list_strings = ["当事人双方均为台湾居民，借贷关系发生在台湾，但被告在大陆有固定住所，也有可供执行的财",
                    "当事人对具有强制执行效力的公证借条的内容有争议提起的诉讼，仅在不予受理申请执行、驳回执行或不予出具执行证书等情况下方可向人民法院提起诉讼",
                    "公证债权文书被裁定不予执行的，当事人可以就该公证债权文书涉及的民事权利义务争议向人民法院提起诉讼",
                    "有下列情形之一的，债权人、利害关系人可以就公证债权文书涉及的民事权利义务争议直接向有管辖权的人民法院提起诉讼"]
    myrules = PrivateLendingRules()
    myrules.get_closest_match("裁判观点", "民间借贷的主体是金融机构")